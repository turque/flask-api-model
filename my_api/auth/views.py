...
from my_api.auth.helpers import (add_token_to_database,
                                        is_token_revoked, revoke_token)
from my_api.extensions import apispec, jwt, pwd_context
...
def register_views():
    apispec.spec.path(view=authenticate, app=app)
